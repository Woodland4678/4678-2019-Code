...
#define ELBOW_POT_1    11//4
#define ELBOW_POT_2    2743 //2481 //2467

//#define WRIST_POT_1    4 // Cargo Intake Straight Out - in dead zone.
#define WRIST_POT_1    876//905 // Hatch Clamp at 90 deg, roller part of claw inwards.
#define WRIST_POT_2    2395//2500 // Hatch Clamp Straight Out.
// 3770 At 90 deg, roller part of cargo claw outwards.
// 905 At 90 deg the other way.  2500 - 905 = 1595
// 3770 - 2500 = 1270. 

#define WAIST_POT_1    3508 //
#define WAIST_POT_2    179//300 
...
bool ManipulatorArm::Init(){
	...
	m_Segs[0]->setCurrentPeakLimit(true,40.0);//40
	...
	m_Segs[1]->setCurrentPeakLimit(true,40.0); //40
	...
	//Wrist
    m_Segs[2]->setVoltageLimit(true, 6); //6
	...
	m_Segs[3]->setCurrentPeakLimit(true,30.0); //30
			...
			case 4:
				...
				if (m_CalCnt == 0) // After a brief wait (5 seconds)
					...
					if (deltaWR < 0.01)
						{
						m_CalCnt2++;
						if (m_CalCnt2 > 5) // After no more wrist motion
