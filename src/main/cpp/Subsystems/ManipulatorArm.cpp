...
#define SHOULDER_POT_1    2943//2706 //2884
#define SHOULDER_POT_2    227//143 //286
...
double ManipulatorArm::getEndEffectorX() {
	return m_Segs[2]->getStartX();
}
double ManipulatorArm::getEndEffectorY() {
	return m_Segs[2]->getStartY();
}
...
double ManipulatorArm::getWaistAngle() {
	return m_Segs[3]->getRelAngle();
}
