...
void Climber::Periodic() {
    ...
    frc::SmartDashboard::PutNumber("Position = ", readTalonSRXEncoder());
}
...
void Climber::moveTo() {
    frc::SmartDashboard::PutNumber("Climber Target", 28000);
    stilts->Set(ControlMode::Position, 28000);
}

void Climber::reset() {
    frc::SmartDashboard::PutNumber("Climber Target", 0);
    stilts->Set(ControlMode::Position, 0);
}
